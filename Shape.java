import java.awt.*;
//public Shape Class with the variables, constructor, getters and setters
...
//drawing the shape boundingbox with the values collected from the spahes classes
        ...
        g.drawLine(bounding.getBottomLeft().getX(),bounding.getBottomLeft().getY(), bounding.getBottomLeft().getX(), bounding.getTopRight().getY());
           ...
           //checking if the shape is filled or not
